...
![](http://7xqsim.com1.z0.glb.clouddn.com/how1.jpeg)

比如，你只需要 `【月日时分】`这四个单位，你可以这样设置beginTime:
![](http://7xqsim.com1.z0.glb.clouddn.com/how2.png)
结束时间 endTime 和 recentTime 也是同理。

**2.我发现，使用『自定义json选择器』有一个非常迫切、刁钻的需求：**
>  ①：用户在自定义JSON的时候期望可以存在不同级别的联动。比如，地区选择器中可能同时存在【北京 → 朝阳】这样的二级联动，也可能存在【广东 → 深圳 → 福田区】这样的三级联动。

所以要设计一种JSON的格式规范，既能够让用户更方便的表达自己想要的JSON，又能让插件能够顺利读到JSON深度，从而动态适应联动。
经过考虑，认为最利落的JSON格式是对象数组，并且每个对象的属性有以下几个：
![](http://7xqsim.com1.z0.glb.clouddn.com/how3.png)
...
![](http://7xqsim.com1.z0.glb.clouddn.com/how5.jpeg)
![](http://7xqsim.com1.z0.glb.clouddn.com/how6.jpeg)
...
![](http://7xqsim.com1.z0.glb.clouddn.com/how8.jpeg)

> ③ -  第二步：用到了自己封装的一个**简单的事件监听函数on**：
![](http://7xqsim.com1.z0.glb.clouddn.com/how4.jpeg)
...
![](http://7xqsim.com1.z0.glb.clouddn.com/how4-2.jpeg)
